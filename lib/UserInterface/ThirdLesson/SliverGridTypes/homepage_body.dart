    ...
    return CustomScrollView(
      slivers: <Widget>[
        ...
        SliverPadding(
          ...
          sliver: SliverList(
            delegate: SliverChildListDelegate(
                getChildren(propertyName: "SliverChildListDelegate")),
          ),
        ),
        SliverPadding(
          padding: EdgeInsets.all(4),
        ...
        SliverPadding(
          ...
          sliver: SliverFixedExtentList(
              delegate: SliverChildListDelegate(getChildren(
                  propertyName:
                      "SliverFixedExtentList.SliverChildListDelegate")),
              itemExtent: 300),
        ),
        SliverPadding(
          padding: EdgeInsets.all(4),
        ...
        SliverGrid(
          ...
          delegate: SliverChildListDelegate(
              getChildren(propertyName: "SliverGrid.SliverChildListDelegate")),
        ),

        //dinamik üretilen (build ile üretilen) elemanlarla bir satırda kac eleman olacagını söyleyebildiğimiz grid türü

        SliverGrid(
          gridDelegate:
              SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 3),
          delegate: SliverChildBuilderDelegate(_createDynamic, childCount: 12),
        ),

        //dinamik üretilen (build ile üretilen) elemanlarla bir satırdaki bir elemanın max genişliğini söylediğimiz grid türü
        SliverGrid(
          gridDelegate:
